...
class AggregateCreationServicesTest
{
	...
	void creationServicePassesCorrelationAndCausationMetadataToDurableProcessMapping()
	{
		...
		service.create(new CreationRequest<>(
				...
				Optional.of(
						new de.gupta.clean.crud.template.useCases.operation.domain.model.id.OperationCorrelationId(
								"corr-1")),
				Optional.of(
						new de.gupta.clean.crud.template.useCases.operation.domain.model.id.OperationCausationId(
								"cause-1"))));
	...
	private static final class AccessDeniedAggregateDefinition extends TestAggregateDefinition
	{
		...
		@Override
		public de.gupta.clean.crud.template.useCases.operation.creation.domain.policy.profile.CreationPolicyProfileResolver creationPolicyProfileResolver()
		{
	...
	private static final class QuarantiningAggregateOrderDefinition extends AggregateOrderDefinition
	{
		...
		@Override
		public de.gupta.clean.crud.template.useCases.operation.creation.domain.policy.invariant.CreationInvariantPolicy<AggregateOrderModel>
