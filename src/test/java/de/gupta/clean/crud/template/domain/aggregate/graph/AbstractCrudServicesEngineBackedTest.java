...
import de.gupta.clean.crud.template.domain.service.aggregate.operation.DefaultAggregateDeleteService;
...
class AbstractCrudServicesEngineBackedTest
{
	...
	void saveAndUpdateServicesMapDomainResultsToResponseModels()
	{
		...
		AggregateWorkflowRunner engine =
	...
	void aggregateCrudServicesSaveServiceCanStartDurableProcesses()
	{
		...
		var engine = DefaultAggregateWorkflowRunner.withTransactionRunnerAndDurableProcessStarter(
	...
	private static final class TestAggregateDefinition
			implements AggregateDefinition<String, String, String, String, String>
	{
