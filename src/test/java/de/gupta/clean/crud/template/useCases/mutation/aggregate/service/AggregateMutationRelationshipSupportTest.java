...
class AggregateMutationRelationshipSupportTest
{
	...
	private record AcknowledgeWithOwnedNote(String noteValue) implements ApplicationMutationPayload
	{
	}

	private record LinkReferencedNote(Long noteId) implements ApplicationMutationPayload
	{
	}
