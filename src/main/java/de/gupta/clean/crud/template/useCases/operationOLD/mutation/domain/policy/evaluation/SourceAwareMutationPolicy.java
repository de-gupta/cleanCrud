package de.gupta.clean.crud.template.useCases.operationOLD.mutation.domain.policy.evaluation;

import de.gupta.clean.crud.template.useCases.operationOLD.domain.model.OperationSource;
import de.gupta.clean.crud.template.useCases.operationOLD.mutation.domain.policy.access.MutationAccessPolicy;
import de.gupta.clean.crud.template.useCases.operationOLD.mutation.domain.policy.invariant.MutationInvariantPolicy;
