...
{
	private final Map<Class<? extends ApplicationMutationPayload>, RegisteredMutationHandler<DomainModel, ?>> handlers;
	...
	DefaultMutationHandlerRegistry(final Collection<RegisteredMutationHandler<DomainModel, ?>> handlers)
	{
		...
		var indexedHandlers = new LinkedHashMap<Class<? extends ApplicationMutationPayload>,
