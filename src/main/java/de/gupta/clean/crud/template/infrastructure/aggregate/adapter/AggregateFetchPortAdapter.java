...
public final class AggregateFetchPortAdapter<DomainId, DomainModel> implements AggregateFetchPort<DomainId, DomainModel>
{
	...
	public static <DomainId, DomainModel> AggregateFetchPortAdapter<DomainId, DomainModel> withPersistenceService(
			final FetchPersistenceService<DomainId, DomainModel> fetchPersistenceService)
	{
		return new AggregateFetchPortAdapter<>(fetchPersistenceService);
	}
	...
	private AggregateFetchPortAdapter(final FetchPersistenceService<DomainId, DomainModel> fetchPersistenceService)
	{
